    ...
    <div className="flex h-full w-full min-h-0 flex-col p-4">
      <div className="flex justify-between items-start mb-3">
        ...
        <div className="flex gap-2 items-center shrink-0">
          ...
          <button onClick={handleClose} title="取消（Esc）" className="text-gray-400 hover:text-white text-lg">✕</button>
        </div>
      </div>
      ...
      <div className="flex-1 min-h-0 relative">
        <textarea
          ...
          className="w-full h-full bg-gray-950 border border-gray-700 rounded-xl p-4 text-sm text-gray-200 leading-relaxed resize-none focus:outline-none focus:border-amber-600"
